<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Order_Application_Seller.Login" %>
            ...
            <div class="card login-card">
                <div class="card-body">
                    ...
                    <div class="row" style="margin:0% 3%;">
						...
						<asp:HyperLink ID="ForgotPassword" runat="server" NavigateUrl="~/ForgotPassword.aspx" style="margin:0% 0% 0% 55%;">Forgot Password?</asp:HyperLink>
                    </div>
                </div>
            </div>
        </div>
